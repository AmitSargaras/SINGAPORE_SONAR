...
*/	
	...
	public abstract Date getAvailmentDate();

	public abstract void setAvailmentDate(Date availmentDate);

	public abstract String getAvailableAmount();

	public abstract void setAvailableAmount(String availableAmount);

	public abstract String getApprovedAmount();

	public abstract void setApprovedAmount(String approvedAmount);

	public abstract String getCategory();

	public abstract void setCategory(String category);

	public abstract String getUserDefinedStatusLabel();

	public abstract void setUserDefinedStatusLabel(String userDefinedStatusLabel);

	public abstract Date getStatusChangedOnDate();

	public abstract void setStatusChangedOnDate(Date statusChangedOnDate);
	...
	/*
	 * public abstract String getLimitRestrictionCustomerRestriction(); public
	 * abstract void setLimitRestrictionCustomerRestriction(String
	 * limitRestrictionCustomerRestriction);
	 */
	public abstract String getSecured();

	public abstract void setSecured(String secured);

	public abstract String getEcbLoan();

	public abstract void setEcbLoan(String ecbLoan);

	public abstract String getProjectLoan();

	public abstract void setProjectLoan(String projectLoan);

	public abstract String getSyndicateLoanLine();

	public abstract void setSyndicateLoanLine(String syndicateLoanLine);

	public abstract Date getScodDate();

	public abstract void setScodDate(Date scodDate);

	public abstract Date getAcodDate();

	public abstract void setAcodDate(Date acodDate);

	public abstract String getFreezLCBGDevoInvok();

	public abstract void setFreezLCBGDevoInvok(String freezLCBGDevoInvok);

	public abstract String getSblcsbbgAvailable();

	public abstract void setSblcsbbgAvailable(String sblcsbbgAvailable);

	public abstract String getSblcsbbgNumber();

	public abstract void setSblcsbbgNumber(String sblcsbbgNumber);

	public abstract String getSblcsbbgIssuingBank();

	public abstract void setSblcsbbgIssuingBank(String sblcsbbgIssuingBank);

	public abstract String getSecurityTaken();

	public abstract void setSecurityTaken(String securityTaken);

	public abstract String getNbfc();

	public abstract void setNbfc(String nbfc);

	public abstract String getTakeoverCases();

	public abstract void setTakeoverCases(String takeoverCases);

	public abstract String getFinanceforQualityAcquisition();

	public abstract void setFinanceforQualityAcquisition(String financeforQualityAcquisition);

	public abstract String getCreditOwner();

	public abstract void setCreditOwner(String creditOwner);

	public abstract String getLoanToValue();

	public abstract void setLoanToValue(String loanToValue);

	public abstract String getProductCodeMultiComboBox();

	public abstract void setProductCodeMultiComboBox(String productCodeMultiComboBox);

	public abstract String getCurrencycodeMultiComboBox();

	public abstract void setCurrencycodeMultiComboBox(String currencycodeMultiComboBox);

	public abstract String getInvestmentAccountNumber();

	public abstract void setInvestmentAccountNumber(String investmentAccountNumber);

	public abstract String getOrderNumber();

	public abstract void setOrderNumber(String orderNumber);

	//public abstract String getFx14Interface();

	//public abstract void setFx14Interface(String fx14Interface);
	/*
	 * public abstract String getRestrictionType(); public abstract void
	 * setRestrictionType(String restrictionType); public abstract String
	 * getCurrencyRestrictionType(); public abstract void
	 * setCurrencyRestrictionType(String currencyRestrictionType);
	 */

	public abstract String getReviewFrequency();
	public abstract void setReviewFrequency(String reviewFrequency);
	public abstract String getLimitStatus();
	public abstract void setLimitStatus(String limitStatus);
	public abstract Date getNextReviewDate();
	public abstract void setNextReviewDate(Date nextReviewDate);
	public abstract String getClosureReason();
	public abstract void setClosureReason(String closureReason);
	public abstract String getFreezeReason();
	public abstract void setFreezeReason(String freezeReason);
	public abstract String getSecuredUnsecured();
	public abstract void setSecuredUnsecured(String securedUnsecured);
	public abstract String getSblc();
	public abstract void setSblc(String sblc);
	public abstract String getSblcno();
	public abstract void setSblcno(String sblcno);
	public abstract String getRealEstate();
	public abstract void setRealEstate(String realEstate);
	public abstract String getIssuingBank();
	public abstract void setIssuingBank(String issuingBank);
	public abstract String getSblcSbbgAmount();
	public abstract void setSblcSbbgAmount(String sblcSbbgAmount);
	public abstract String getSblcSbbgPercent();
	public abstract void setSblcSbbgPercent(String sblcSbbgPercent);
	public abstract String getOrderId();
	public abstract void setOrderId(String orderId);
	public abstract String getLtv();
	public abstract void setLtv(String ltv);
	public abstract String getInvestmentId();
	public abstract void setInvestmentId(String investmentId);
	public abstract String getTakeoverLoan();
	public abstract void setTakeoverLoan(String takeoverLoan);
    public abstract String getSblcApplicant();
	public abstract void setSblcApplicant(String sblcApplicant);
}