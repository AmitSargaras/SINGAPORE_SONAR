...
public interface IGlobalConstant {
    ...
    public static final String MAXIMUM_ALLOWED_AMOUNT_21_3_STR = "999999999999999999999.999";
    public static final double MAXIMUM_ALLOWED_AMOUNT_21_3 = Double.parseDouble(MAXIMUM_ALLOWED_AMOUNT_21_3_STR);
    
    public static final String MAXIMUM_ALLOWED_AMOUNT_24_3_STR = "999999999999999999999999.999";
    public static final double MAXIMUM_ALLOWED_AMOUNT_24_3 = Double.parseDouble(MAXIMUM_ALLOWED_AMOUNT_24_3_STR);
}
