...
public class LmtXRefAction extends LmtDetailAction {
	...
	private String getReference(String event, HashMap resultMap, HashMap exceptionMap) {
		...
		if (EventConstant.EVENT_READ.equals(event)) {
			return "read_xref";
				...
				|| EventConstant.EVENT_PREPARE_UPDATE_ERROR.equals(event)
				) {
			return "update_xref";
		}
		...
		}else if( EventConstant.FETCH_COBORROWER_NAME_SG.equals(event)){
			return "fetch_CoBorrowerName_SG";
		}	
	...
	protected String getErrorEvent(String event) {
		...
		if (EventConstant.EVENT_CREATE.equals(event)) {
			...
			return EventConstant.EVENT_PREPARE_UPDATE_ERROR;
