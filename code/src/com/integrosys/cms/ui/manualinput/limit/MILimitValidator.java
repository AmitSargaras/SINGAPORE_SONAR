			...
			if(ASSTValidator.isValidAlphaNumStringWithSpace((xrefForm.getReleasedAmount().replaceAll(",", "")))) {
			 ...
			 if (!(errorCode = Validator.checkString(xrefForm.getInterestRateType(), true, 1, 40))
					...
					if(xrefForm.getInterestRateType().equals("fixed") && xrefForm.getIntRateFix().equals("")){
						...
						if (!(errorCode = Validator.checkNumber(xrefForm.getIntRateFix(), false , 0, IGlobalConstant.MAXIMUM_ALLOWED_AMOUNT_2_2,3,locale))
								.equals(Validator.ERROR_NONE)) {
					...
					if(xrefForm.getInterestRateType().equals("floating") &&	!xrefForm.getIntRateFloatingMargin().equals("") ){
						if (!(errorCode = Validator.checkNumber(xrefForm.getIntRateFloatingMargin(), false,0 ,IGlobalConstant.MAXIMUM_ALLOWED_AMOUNT_2_2 ,3 ,locale))
								.equals(Validator.ERROR_NONE)) {
