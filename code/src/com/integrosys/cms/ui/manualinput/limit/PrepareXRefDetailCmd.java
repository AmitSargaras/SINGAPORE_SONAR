...
public class PrepareXRefDetailCmd extends AbstractCommand {
	public String[][] getParameterDescriptor() {
		...
		/*	 { "xrefDetailForm", "java.lang.Object", FORM_SCOPE },*/
				...
				{ "productCodeMultiComboBox", "java.lang.String", REQUEST_SCOPE },
				{ "currencycodeMultiComboBox", "java.lang.String", REQUEST_SCOPE }
				});
	}
...
//					curAccount.setCloseFlag("Y");
			...
			String singaporeSystem=PropertyManager.getValue("singapore.systemName");
			long currentSId= ICMSConstant.LONG_INVALID_VALUE;
 		...
 		//	ResourceBundle bundle = ResourceBundle.getBundle("ofa");
			...
			if(singaporeSystem.equals(lmtTrxObj.getStagingLimit().getFacilitySystem())) {
				List productAllowedList = productMasterDao.getProductMasterList();
				List productMasterLbValList = new ArrayList();
				try {
					for (int i = 0; i < productAllowedList.size(); i++) {
				...
				productAllowedList = CommonUtil.sortDropdown(productMasterLbValList);				
				String productCodeMultiComboBox=(String) (map.get("productCodeMultiComboBox"));
				List productAllowedList1=new ArrayList();
				if(null==productCodeMultiComboBox ||  "".equals(productCodeMultiComboBox)) {
					productCodeMultiComboBox=curAccount.getProductCodeMultiComboBox();
				}
				
				if(null!=productCodeMultiComboBox) {
				...
				ILimitDAO dao = LimitDAOFactory.getDAO();				
				List currencyAllowedList = dao.getCurrencyList();
				String currencycodeMultiComboBox=(String) (map.get("currencycodeMultiComboBox"));
				List currencyAllowedList1=new ArrayList();
				if(null==currencycodeMultiComboBox ||  "".equals(currencycodeMultiComboBox)) {
					currencycodeMultiComboBox=curAccount.getCurrencycodeMultiComboBox();
				}				
				if(null!=currencycodeMultiComboBox) {
