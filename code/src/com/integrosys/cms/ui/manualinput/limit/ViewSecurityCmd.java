...
public class ViewSecurityCmd extends AbstractCommand {
	...
	public String[][] getResultDescriptor() {
		return (new String[][] {{ "lmtId", "java.lang.String", REQUEST_SCOPE },
				...
				{ "collObj", "java.util.Collection", SERVICE_SCOPE },
				});
	}
	...
	public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException,
		...
		result.put("lmtId", lmtID); //Shiv 300911
		result.put("securityId", securityId); //Shiv 051111
		try{
			result.put("collObj", getCollateralDetails(Long.parseLong(securityId)));
		}catch(Exception e){
			e.printStackTrace();
		}
	...
	private ICollateral getCollateralDetails(long colId) {
		try {
			return CollateralBusManagerFactory.getActualCollateralBusManager().getCollateral(colId);			
		}
		catch (Exception ex) {
