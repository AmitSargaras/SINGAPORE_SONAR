...
//			xrefDetailForm.setRemark(account.getRemark());
			...
			//Added for Singapore 
			xrefDetailForm.setDescription(account.getDescription());
			//xrefDetailForm.setLinecurrency(account.getLinecurrency());
			xrefDetailForm.setAvailmentDate(DateUtil.formatDate(locale,account.getAvailmentDate()));
			xrefDetailForm.setAvailableAmount(UIUtil.formatWithCommaAndDecimalBigDecimal(account.getAvailableAmount()));
			xrefDetailForm.setApprovedAmount(UIUtil.formatWithCommaAndDecimalBigDecimal(account.getApprovedAmount()));
			xrefDetailForm.setCategory(account.getCategory());
			xrefDetailForm.setUserDefinedStatusLabel(account.getUserDefinedStatusLabel());
			xrefDetailForm.setStatusChangedOnDate(DateUtil.formatDate(locale, account.getStatusChangedOnDate()));
			xrefDetailForm.setClassCode(account.getClassCode());
		//	xrefDetailForm.setLimitRestrictionCustomerRestriction(account.getLimitRestrictionCustomerRestriction());
			xrefDetailForm.setSecured(account.getSecured());
			xrefDetailForm.setEcbLoan(account.getEcbLoan());
			xrefDetailForm.setProjectLoan(account.getProjectLoan());
			xrefDetailForm.setSyndicateLoanLine(account.getSyndicateLoanLine());
			xrefDetailForm.setScodDate(DateUtil.formatDate(locale, account.getScodDate()));
			xrefDetailForm.setAcodDate(DateUtil.formatDate(locale, account.getAcodDate()));
			xrefDetailForm.setFreezLCBGDevoInvok(account.getFreezLCBGDevoInvok());
			xrefDetailForm.setSblcsbbgAvailable(account.getSblcsbbgAvailable());
			xrefDetailForm.setSblcsbbgNumber(account.getSblcsbbgNumber());
			xrefDetailForm.setSblcsbbgIssuingBank(account.getSblcsbbgIssuingBank());
			xrefDetailForm.setSecurityTaken(account.getSecurityTaken());
			xrefDetailForm.setNbfc(account.getNbfc());
			xrefDetailForm.setTakeoverCases(account.getTakeoverCases());
			xrefDetailForm.setFinanceforQualityAcquisition(account.getFinanceforQualityAcquisition());
			xrefDetailForm.setCreditOwner(account.getCreditOwner());
			xrefDetailForm.setLoanToValue(account.getLoanToValue());
			xrefDetailForm.setProductCodeMultiComboBox(account.getProductCodeMultiComboBox());
			xrefDetailForm.setCurrencycodeMultiComboBox(account.getCurrencycodeMultiComboBox());
			xrefDetailForm.setInvestmentAccountNumber(account.getInvestmentAccountNumber());
			//xrefDetailForm.setNpaRuleId(account.getNpaRuleId());
			xrefDetailForm.setOrderNumber(account.getOrderNumber());
			//xrefDetailForm.setFx14Interface(account.getFx14Interface());
			/*xrefDetailForm.setRestrictionType(account.getRestrictionType());
			xrefDetailForm.setCurrencyRestrictionType(account.getCurrencyRestrictionType());*/
			
			xrefDetailForm.setReviewFrequency(account.getReviewFrequency());
			xrefDetailForm.setLimitStatus(account.getLimitStatus());
			xrefDetailForm.setNextReviewDate(DateUtil.formatDate(locale,account.getNextReviewDate()));
			xrefDetailForm.setClosureReason(account.getClosureReason());
			xrefDetailForm.setFreezeReason(account.getFreezeReason());
			xrefDetailForm.setSecuredUnsecured(account.getSecuredUnsecured());
			xrefDetailForm.setSblc(account.getSblc());
			xrefDetailForm.setSblcno(account.getSblcno());
			xrefDetailForm.setRealEstate(account.getRealEstate());
			xrefDetailForm.setIssuingBank(account.getIssuingBank());
			xrefDetailForm.setSblcSbbgAmount(account.getSblcSbbgAmount());
			xrefDetailForm.setSblcSbbgPercent(account.getSblcSbbgPercent());
			xrefDetailForm.setOrderId(account.getOrderId());
			xrefDetailForm.setLtv(account.getLtv());
			xrefDetailForm.setInvestmentId(account.getInvestmentId());
			xrefDetailForm.setTakeoverLoan(account.getTakeoverLoan());
			xrefDetailForm.setSblcApplicant(account.getSblcApplicant());
...
//						}
				...
				account.setStatus(xrefDetailForm.getStatus());
					...
					account.setStatus("PENDING_UPDATE");
					if("Singapore".equalsIgnoreCase(singaporeFacSystem)) {
						account.setAction("MODIFY");	
					}
				}
				...
				//Added for Singapore
				account.setDescription(xrefDetailForm.getDescription());
			//	account.setLinecurrency(xrefDetailForm.getLinecurrency());
				if(null!=xrefDetailForm.getAvailmentDate()) {
				account.setAvailmentDate(DateUtil.convertDate(locale,xrefDetailForm.getAvailmentDate()));
				}else {
					account.setAvailmentDate(null);	
				}
				account.setAvailableAmount(UIUtil.removeComma(xrefDetailForm.getAvailableAmount()));
				account.setApprovedAmount(UIUtil.removeComma(xrefDetailForm.getApprovedAmount()));
				account.setCategory(xrefDetailForm.getCategory());
				account.setUserDefinedStatusLabel(xrefDetailForm.getUserDefinedStatusLabel());
				if(null!=xrefDetailForm.getStatusChangedOnDate()) {
				account.setStatusChangedOnDate(DateUtil.convertDate(locale, xrefDetailForm.getStatusChangedOnDate()));
				}else {
					account.setStatusChangedOnDate(null);	
				}
				account.setClassCode(xrefDetailForm.getClassCode());
			//	account.setLimitRestrictionCustomerRestriction(xrefDetailForm.getLimitRestrictionCustomerRestriction());
				account.setSecured(StringUtils.trim(xrefDetailForm.getSecured()));
				account.setEcbLoan(StringUtils.trim(xrefDetailForm.getEcbLoan()));
				account.setProjectLoan(StringUtils.trim(xrefDetailForm.getProjectLoan()));
				account.setSyndicateLoanLine(StringUtils.trim(xrefDetailForm.getSyndicateLoanLine()));
				if(null!=xrefDetailForm.getScodDate()) {
				account.setScodDate(DateUtil.convertDate(locale, xrefDetailForm.getScodDate()));
				}else {
					account.setScodDate(null);
				}
				if(null!=xrefDetailForm.getAcodDate()) {
				account.setAcodDate(DateUtil.convertDate(locale, xrefDetailForm.getAcodDate()));
				}else {
					account.setAcodDate(null);
				}
				account.setFreezLCBGDevoInvok(xrefDetailForm.getFreezLCBGDevoInvok());
				account.setSblcsbbgAvailable(xrefDetailForm.getSblcsbbgAvailable());
				account.setSblcsbbgNumber(xrefDetailForm.getSblcsbbgNumber());
				account.setSblcsbbgIssuingBank(xrefDetailForm.getSblcsbbgIssuingBank());
				account.setSecurityTaken(xrefDetailForm.getSecurityTaken());
				account.setNbfc(xrefDetailForm.getNbfc());
				account.setTakeoverCases(xrefDetailForm.getTakeoverCases());
				account.setFinanceforQualityAcquisition(xrefDetailForm.getFinanceforQualityAcquisition());
				account.setCreditOwner(xrefDetailForm.getCreditOwner());
				account.setLoanToValue(xrefDetailForm.getLoanToValue());
				account.setProductCodeMultiComboBox(xrefDetailForm.getProductCodeMultiComboBox());
				account.setCurrencycodeMultiComboBox(xrefDetailForm.getCurrencycodeMultiComboBox());
				account.setInvestmentAccountNumber(xrefDetailForm.getInvestmentAccountNumber());
			//	account.setNpaRuleId(xrefDetailForm.getNpaRuleId());
				account.setOrderNumber(xrefDetailForm.getOrderNumber());
				//account.setFx14Interface(xrefDetailForm.getFx14Interface());
			/*	account.setRestrictionType(xrefDetailForm.getRestrictionType());
				account.setCurrencyRestrictionType(xrefDetailForm.getCurrencyRestrictionType());*/

				account.setReviewFrequency(xrefDetailForm.getReviewFrequency());
				account.setLimitStatus(xrefDetailForm.getLimitStatus());
				if(null!=xrefDetailForm.getNextReviewDate()) {
				account.setNextReviewDate(DateUtil.convertDate(locale,xrefDetailForm.getNextReviewDate()));
				}else {
					account.setNextReviewDate(null);	
				}
				account.setClosureReason(xrefDetailForm.getClosureReason());
				account.setFreezeReason(xrefDetailForm.getFreezeReason());
				account.setSecuredUnsecured(xrefDetailForm.getSecuredUnsecured());
				account.setSblc(xrefDetailForm.getSblc());
				account.setSblcno(xrefDetailForm.getSblcno());
				account.setRealEstate(xrefDetailForm.getRealEstate());
				account.setIssuingBank(xrefDetailForm.getIssuingBank());
				account.setSblcSbbgAmount(xrefDetailForm.getSblcSbbgAmount());
				account.setSblcSbbgPercent(xrefDetailForm.getSblcSbbgPercent());
				account.setOrderId(xrefDetailForm.getOrderId());
				account.setLtv(xrefDetailForm.getLtv());
				account.setInvestmentId(xrefDetailForm.getInvestmentId());
				account.setTakeoverLoan(xrefDetailForm.getTakeoverLoan());
				account.setSblcApplicant(xrefDetailForm.getSblcApplicant());
